...
void ADamageableCharacterBase::RespondToDamageAvoided(const FDamageInfo& DamageInfo)
{
}

void ADamageableCharacterBase::RespondToHealReceived(float HealAmount, AActor* Healer)
{
}
